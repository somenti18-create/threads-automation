...
POST_TYPES_BY_SLOT = [
    {   # JST 07:00 朝の共感
        "type": "viral", "label": "告白型",
        "description": """「正直お店を辞めようかと思った」レベルの深刻な本音から始める。悩み代弁目線。
施術・店舗経営で体ボロボロ、寝る時間削ってSNS、でも売上0を短く積み重ねる。
→ 原因は「見せ方」が少し違っただけ
→ 断定か自然な余韻で終わる。50〜110文字・改行多め"""
    },
    {   # JST 08:30 スクロール停止
        "type": "viral", "label": "フック型",
        "description": """冒頭1行に「えっ？」となる強い数字や事実を置く。悩み代弁目線。
例）「フォロワーが1000人もいるのに予約が0。」「毎日投稿して3ヶ月。売上は0のまま。」
→ 深刻な感情（廃業が頭をよぎった・誰にも言えなかった）
→ 気づき・変化を断定で終わる。50〜110文字・改行多め"""
    },
    {   # JST 10:00 繋がり
        "type": "connect", "label": "繋がり投稿（箇条書き型）",
        "description": """「整体・サロン・パーソナルトレーナーでSNSや集客に悩んでる方と繋がりたいんですよね」形式。
ペルソナの悩みから3つ箇条書き。締めは「困ってる人も繋がりましょう！お話聞くだけでも全然大丈夫です！」50〜110文字"""
    },
    {   # JST 11:30 逆説
        "type": "viral", "label": "逆説型",
        "description": """「〇〇してるのに〇〇」という逆説を冒頭に。悩み代弁目線。
例）「フォロワーが100人も増えたのに予約が0。」
→「なのに」「どうしても」「それでも」で深刻さを強調
→ 原因は「見せ方」が違っただけ。最後は「〜な人いませんか？」か断定。50〜110文字・改行多め"""
    },
    {   # JST 13:00 DM誘導
        "type": "dm", "label": "DM誘導型",
        "description": """ペルソナの深刻な悩みに共感してから「話を聞きたい」でDMに誘導する。
→ 冒頭：ペルソナの悩みを1〜2行で代弁
→ 中盤：「そういう方の話をもっと聞きたいと思ってます」
→ 締め：「気軽にご連絡ください！」（これ以外NG）。押し売りゼロ。50〜110文字・改行多め"""
    },
    {   # JST 15:00 問題提起
        "type": "viral", "label": "問題提起型",
        "description": """「〇〇って意味ないな」「〇〇は間違いだった」と一般的な努力を疑う一言から始める。支援者目線でもOK。
→ 数字は出てるのに売上0などの状況
→ 見せ方を変えたら違った
→ 最後は「〜な人いるんじゃないかな」か「〜な人いませんか？」50〜110文字・改行多め"""
    },
    {   # JST 17:00 実績型
        "type": "viral", "label": "実績型",
        "description": """自分が支援した実際の事例を感情ベースで語る。支援者目線。売り込みNG。
例）「あるサロンさん、フォロワー300人のまま月20件の新規予約になった話。」
→ 支援前の状況（数字・感情）→ 何を変えたか（見せ方のみ・詳細は言わない）→ 変化後の事実
→ 最後は気づきの断定か「〜な方いませんか？」50〜110文字・改行多め"""
    },
    {   # JST 19:00 繋がり（問いかけ）
...
→ 締めは「困ってる人も繋がりましょう！お話聞くだけでも全然大丈夫です！」50〜110文字・改行多め"""
    },
    {   # JST 21:00 ストーリー（元公務員）
        "type": "viral", "label": "ストーリー型",
        "description": """元公務員→転売→動画編集→起業という自分の転換ストーリーを感情ベースで語る。元公務員目線。
エピソード候補（毎回違うものを選ぶ）：公務員を辞めた日のこと・転売で失敗したこと・起業を決めた瞬間
→ 短い事実の積み重ね（1文1行）
→ 最後は「結局〜だった。」など断定で終わる。問いかけなし。50〜110文字・改行多め"""
    },
    {   # JST 22:30 繋がり（宣言）
        "type": "connect", "label": "繋がり投稿（宣言型）",
        "description": """「整体・サロン・トレーナーの方の見せ方を変えるのを手伝いたいと思ってます」という宣言から始める。
→ なぜそう思うか（技術があるのに伝わらないのはもったいない）
→ 締めは「困ってる人も繋がりましょう！お話聞くだけでも全然大丈夫です！」50〜110文字・改行多め"""
    },
]
