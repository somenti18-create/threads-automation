...
結論を押しつけない。「〜なんですよね」で終わる。80〜200文字"""
    },
    {   # JST 10:00 繋がり
...
締めは「気軽にお話しましょう！」か「困ってる人も繋がりましょう！お話聞くだけでも全然大丈夫です！」80〜200文字"""
    },
    {   # JST 11:30 クライアント事例
...
→ 締め：「気軽にご連絡ください！」（これ以外NG）。押し売りゼロ。80〜200文字"""
    },
    {   # JST 15:00 実験・検証
...
→ 仮説 → やったこと → 結果（数字） → 解釈
「これが全てじゃないけど〜」のような余白を残して終わる。80〜200文字"""
    },
    {   # JST 17:00 本音・失敗
...
締めは「困ってる人も繋がりましょう！お話聞くだけでも全然大丈夫です！」80〜200文字"""
    },
...
「結局〜だった。」など断定で終わる。説明しすぎない。80〜200文字"""
    },
    {   # JST 22:30 繋がり
